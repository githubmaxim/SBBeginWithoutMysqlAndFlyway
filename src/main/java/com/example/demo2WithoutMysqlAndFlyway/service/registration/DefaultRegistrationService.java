...
import com.example.demo2WithoutMysqlAndFlyway.entity.registration.Role;
import com.example.demo2WithoutMysqlAndFlyway.repository.registration.RegistrationRepository;
...
public class DefaultRegistrationService implements RegistrationService {
    ...
    public String addUser(LogPasDto logPasDto, Map<String, Object> model) {
        ...
        logPasDto.setRoles(Collections.singleton(Role.ADMIN));
